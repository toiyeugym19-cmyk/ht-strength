...
```bash
INIT=$(node "D:/gym 2/tap gyp/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "D:/gym 2/tap gyp/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "D:/gym 2/tap gyp/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "D:/gym 2/tap gyp/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
