...
Reference full template: `D:/gym 2/tap gyp/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/gym 2/tap gyp/.claude/get-shit-done/templates/state.md`.
