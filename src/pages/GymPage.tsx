            ...
            <motion.div variants={fadeUp} className="mb-6">
                <div className="superapp-card-glass p-5 rounded-[28px] flex items-center gap-4 relative overflow-hidden group">
                    ...
                    <div className="flex-1">
                        <p className="text-[11px] font-black uppercase tracking-[0.1em] text-[#BF5AF2]">Cấp Độ Vận Động Viên</p>
                        <h3 className="text-[18px] font-black text-white tracking-tight mt-0.5">
                            {userProfile.trainingClass === 'BEGINNER' ? 'CƠ BẢN' : userProfile.trainingClass === 'INTERMEDIATE' ? 'TRUNG BÌNH' : userProfile.trainingClass === 'ADVANCED' ? 'NÂNG CAO' : 'TINH ANH'}
                        </h3>
                    </div>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-3 mt-1 text-[11px] font-bold text-white/30">
                                        ...
                                        <span className="flex items-center gap-1.5"><Clock size={12} /> {log.reps} lần</span>
                                    </div>
                                </div>
