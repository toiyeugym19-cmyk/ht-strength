...
import { Zap, FileText, Database, Network, LineChart, Terminal } from 'lucide-react';
...
export const NeuralScreen = ({ nav }: { nav: NavFunction }) => {
    ...
    const neuralSubFeatures = [
        ...
        { icon: LineChart, label: 'Chẩn đoán', desc: 'System health', screen: 'neural_diagnostics' as Screen, color: 'bg-red-600' },
    ];
