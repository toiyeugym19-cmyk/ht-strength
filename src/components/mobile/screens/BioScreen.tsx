...
import { LineChart, Target, Shield, Calendar, Settings, RefreshCw } from 'lucide-react';
...
export const BioScreen = ({ nav }: { nav: NavFunction }) => {
    ...
    const bioSubFeatures = [
        { icon: LineChart, label: 'Sức khỏe', desc: 'Theo dõi chỉ số', screen: 'bio_health' as Screen, color: 'bg-red-600' },
