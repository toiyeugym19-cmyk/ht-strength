...
export const MEMBER_RANKS: MemberRank[] = [
    { label: 'Legend',  emoji: '🏆', color: 'text-yellow-400',  min: 200 },
    { label: 'Elite',   emoji: '💎', color: 'text-purple-400',  min: 50  },
    { label: 'Pro',     emoji: '🥇', color: 'text-blue-400',    min: 10  },
    { label: 'Newbie',  emoji: '🌱', color: 'text-zinc-500',    min: 0   },
];
